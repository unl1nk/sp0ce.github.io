...
Bunu test amaçlı yazdık, burada virtual codes bakıp, basılan tuş var ise cmd ekranına yazıyor. Tabiki biz bunu istemeyiz, o yüzden bunu bir dosyaya kaydetmemiz gerekiyor. Çünkü biz çalıştığı zaman cmd'i açık bıraktırmamız lazım. 
