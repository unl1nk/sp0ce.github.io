...
Persistence temeli olan kayıt defterine ekleme olayı, keylogger'ın her seferinde tekrar açmak yerine makine açıldığı an otomatik keylogger'ın da açılmasını sağlıyor. 
...
İkinci serimiz büyük ihtimal Worm ile girip, Download and Execute zararlı yazılımlardan bahsedeceğim.
